...
save(outcomeSim, file=paste0(paperdir,"/dataResults/outcomeSim.RData"))
cat(paste0(date(), ', nreps=', nreps, '\n'),
    paste(c(names(st),'\n', collapse=T)),
    st,
    file=paste0(paperdir,'/dataResults/fullOutcomeSim-runtime.txt', append=TRUE))
} else load(paste0(paperdir,'/dataResults/outcomeSim.RData'))
```
...
save(totalPoly,file=paste0(paperdir,"/dataResults/totalPolySim.RData"))
save(ikp,file=paste0(paperdir,"/dataResults/ikp.RData"))
cat(paste0(date(), ', nreps=', nreps, '\n'),
    paste(c(names(st),'\n', collapse=T)),
    st,
