...
# Methods to help pick out the RCT within a RDD

## Methods to help pick out the RCT within a RDD {.build}
...
<div class="notes">
- It's one thing to say "there was natural randomization," another to assert a precise analogy to a specific hypothetical RCT. 
...
- Our analysis sets width of $\mathcal{W}$ to precisely 1 grade point, our guess at the S.E. of measurent for freshman year GPA.  Removing linear trend, its residuals are perfectly balanced.  

</div>

## Local randomization & density of $R$ | the McCrary [-@mccrary2008manipulation] test
...
<!--
>  - Pick narrow $\tilde{\mathcal{W}} \subseteq \mathcal{W}$, test $\tilde{H}: \log \big[\frac{d}{dt} \mathrm{Pr}(R \leq t)\big]_{t=R} \perp Z | \{R \in \tilde{\mathcal{W}}\}.$
-->
