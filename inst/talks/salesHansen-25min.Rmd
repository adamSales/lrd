...
> - Regression-based view [@thistlethwaite1960regression]: Assume $Y = \alpha + \tau Z + \beta R + \epsilon$, $\epsilon \perp R$, at least locally [@hahn2001iae; @imbens2008regression, ...].  The causal effect is $\tau$. 
...
>  - Here we fail, due to students at $R=0$ who narrowly avoided AP.

  <img src="images/forcing-discrete.jpg" width="300px" height="300px" />

> - To avoid wrath of McCrary, exclude $\{i: R_i =0\}$.
