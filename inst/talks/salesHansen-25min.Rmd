...
> A: With RDDs, there's a better option than post hoc sensitivity analysis.  
You can address sensitivity to contamination (as opposed to omitted variables) as a part of the primary analysis, with the help of robust regression.
While unfamiliar, these methods are efficient, easy to use and readily available in R and Stata.
