...
date: "2017 ICSA Conference, Chicago"
...
Suppose a latent subgroup, "savvy," that's overrepresented in $\{i: z_i=0\}$.  We can't locate them, but if we could we'd take them all out. How much could this change effect estimates? 
...
##Bounded influence robust regression | some relevant history
...
- <!-- Asymptotically,--> Only these methods limit sensitivity to contamination of a $O(n^{-1/2})$ share of the sample [@he1991localbreakdown; @yohaiZamar1997locallyrobustMestimates].
...
##  Results for the LSO study

 Regarding academic probation at the 3 Canadian universities, MM estimation w/ bisquare tells a different story than local randomization methods without detrending, but a similar story to a common limit-based method.
...
<!--  (To assign 0's to truly anomalous observations, not just any robust method will do; you need bounded influence regression.)- (To assign 0's to truly anomalous observations, not just any robust method will do; you need bounded influence regression.)- (To assign 0's to truly anomalous observations, not just any robust method will do; you need bounded influence regression.) -->
...
> A: Sometimes yes, sometimes no. If not, then you're told why not, and the answer is likely to impugn the other method.
