...
however, to our knowledge, combining linear and generalized linear
models is not supported in current software implementations, so
covariates of mixed type might pose problems.  Alternatively, balance
assessments could be combined in a hierarchical Bayesian model
