...
\subsection{Model Misspecification, Sample Contamination, and Specification Tests}\label{sec:specification}
...
The RDD literature, in general, has responded with specification tests
