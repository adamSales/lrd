...
2017, when Maria hit, and then used 2017 data to estimate effects, treating residuals as ignorable, \emph{vis
...
Subsets of the analysis sample that do not satisfy Residual Ignorability
 can undercut the validity of an RDD analysis, \marginpar{wc} provided
that these subsets include influential observations. 
